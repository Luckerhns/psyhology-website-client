  ...
  return (
    <MainLayout>
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые Килибарда Карина
        Валерьевна (далее – Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта https://kilibarda.ru.
      </p>
      <br />
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://kilibarda.ru.
      </p>
      {/*  */}
      <p>
      ...
      <p>
        ...
        <a href="https://kilibarda.ru">https://kilibarda.ru</a>.
      </p>{" "}
      <p>
      ...
      <ul>
        ...
        <ul>
          ...
          <strong>
            ...
            Законом о персональных данных и принятых в соответствии с ним
            нормативных правовых актов, если иное не предусмотрено Законом о
      ...
      <ul>
        ...
        <strong>– на отзыв согласия на обработку персональных данных;</strong>
        <strong>
      ...
      <ul>
        {" "}
        <strong>5.1. Фамилия, имя, отчество.</strong>
        <strong>5.2. Электронный адрес.</strong>
        <strong>5.3. Номера телефонов.</strong>
        <strong>
      ...
      <p>
        ...
        почты karina.kilibarda@gmail.com с пометкой «Отказ от уведомлений о
        новых продуктах и услугах и специальных предложениях».
      </p>
      <p>
        7.3. Обезличенные данные Пользователей, собранные с помощью сервисов
      ...
      <p>
        ...
        специальные формы, расположенные на сайте https://kilibarda.ru или
      ...
      <p>
        ...
        персональных данных на обработку его персональных данных. Оператор
        обрабатывает персональные данные только в случае их заполнения и/или
        отправки Пользователем самостоятельно через специальные формы,
        расположенные на сайте https://kilibarda.ru или направленные Оператору
      ...
      <p>
        ...
        поручителем. Осуществляется обработка персональных данных, доступ
        неограниченного круга лиц к которым предоставлен субъект персональных
      ...
      <p>
        9.6. Осуществляется обработка персональных данных, подлежащих
      ...
      <p>
        ...
        karina.kilibarda@gmail.com с пометкой «Актуализация персональных
        данных».
      </p>
      <p>
      ...
      <p>
        ...
        Оператору с помощью электронной почты karina.kilibarda@gmail.com.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://kilibarda.ru/privacy
      </p>
    </MainLayout>
  );
};
